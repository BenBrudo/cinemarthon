...
import { Link, Allocine, Facebook } from "../components/Icons";

export const Footer: React.FC = () => (
  <footer className="px-6 mt-24 text-gray-900 bg-center bg-cover shadow-md md:px-0 bg-gray-200/40">
    <div className="mx-auto text-center py-14 md:w-5/12 md:px-0">
      <div className="flex flex-col space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a
            rel="noreferrer"
            target="_blank"
            href="https://www.allocine.fr/seance/salle_gen_csalle=W0116.html"
            className="hover:underline"
          >
            <Allocine className="w-8 h-8 transition-opacity hover:opacity-75" />
          </a>

          <a
            rel="noreferrer"
            target="_blank"
            href="https://www.facebook.com/p/Cin%C3%A9Marthon-100064798413774"
            className="hover:underline"
          >
            <Facebook className="w-8 h-8 transition-opacity hover:opacity-75" />
          </a>
          ...
          <a
            ...
            className="hover:underline"
            target="_blank"
            href="https://www.cinefil.com/cinema/le-silverado-marthon/programmation"
          >
