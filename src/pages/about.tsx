  ...
  <>
    ...
    <div className="px-4 md:px-8 lg:px-12 space-y-12 md:space-y-24">
      ...
      <div className="space-y-6 md:space-y-12">
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
          <div className="flex-1 space-y-3 md:space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-700">L&apos;&eacute;quipe des b&eacute;n&eacute;voles</h2>
      ...
      <div className="space-y-6 md:space-y-12">
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
          <div className="flex-1 space-y-3 md:space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-700">Le Cin&eacute;ma Silverado</h2>
            <p className="text-sm md:text-base text-gray-600 leading-relaxed">
